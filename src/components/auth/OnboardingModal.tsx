...
export function OnboardingModal({ open, onClose }: OnboardingModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-white safe-area-inset">
      {/* Close button */}
      <button
        onClick={handleClose}
      ...
      <div className="flex-1 overflow-auto">
        ...
        <ul className="space-y-4 text-foreground/80 text-sm leading-relaxed">
          <li className="flex gap-3">
            ...
            <span>
              Svara på lite frågor för att vi ska ta reda på vad ditt besvär är och om du kvalificerar dig för dietistvård eller om du ska prata med en kostrådgivare.
            </span>
          </li>
          <li className="flex gap-3">
            <span className="flex-shrink-0 w-6 h-6 bg-primary text-primary-foreground rounded-full flex items-center justify-center text-xs font-medium">
