...
export const CATEGORY_SECTIONS: Record<string, SectionDef[]> = {
  ...
  eating_disorder: [
    { value: "ed_focus", label: "Dagens fokus", description: "Stödjande fokustext från dietist eller AI" },
    { value: "ed_meal_rhythm", label: "Måltidsrytm idag", description: "Automatisk från journalen: frukost, lunch, middag, mellanmål" },
    { value: "ed_meal_structure", label: "Måltidsstruktur (7d)", description: "Automatisk analys av senaste veckans mönster" },
    { value: "ed_regularity_30d", label: "Regelbundenhet (30d)", description: "Automatisk 30-dagars heatmap från journalen" },
    { value: "ed_behavior_goals", label: "Beteendemål", description: "Aktiva delmål från behandlingsplanen" },
    { value: "ed_symptom_patterns", label: "Symptommönster", description: "Automatisk mönsteranalys från symptomloggar" },
    { value: "ed_weekly_checkin", label: "Veckoöversikt (7d)", description: "Automatisk sammanfattning av senaste veckan" },
    { value: "ed_follow_up", label: "Nästa samtal", description: "Kommande videosamtal och fokus" },
    { value: "treatment_plan", label: "Behandlingsplan", description: "Mål och delmål" },
  ],
  womens_health: [
