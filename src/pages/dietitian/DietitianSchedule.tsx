                    ...
                    return (
                      ...
                      >
                        {apptAtSlot ? (
                          ...
                          >
                            <div
                              className="absolute inset-0.5 flex items-center rounded px-1 text-xs cursor-pointer hover:ring-1 hover:ring-blue-400/30 transition-all bg-blue-100 text-blue-700"
